...
include 'topbar.php';
$id = $_GET['id'];
$result = $db_con->prepare("SELECT fname,lname,email,password FROM users WHERE id = :id");
...
?>
    <div class="sub-wrapper2">
        <h1 class="main-header1">Manage Account</h1>
        <hr class="line">
    </div>
    <div class="container-fluid">
        <div class="col-3">
            <div class="card-1 card-outline card-primary">
                <div class="card-body">
                    <form action="form_handler/usr_manage.php" method="POST" id="edit_staff">
                        <div class="row">
                            <div class="form-col2">
                                <div class="row">
                                ...
                                <div class="col-2">
                                    ...
                                    <a href="index.php" class="btn2">Cancel</a>
                                </div>
